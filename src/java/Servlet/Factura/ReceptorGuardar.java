 ...
 * @author DIN-CB03-PC
 */
public class ReceptorGuardar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            String Rfc, Razon_Social, Calle, NumInt, NumExt, Colonia, Codigo_Postal, Municipio, Estado, Pais;
        ...
        Receptor obj = new Receptor(Rfc, Razon_Social, Calle, NumInt, NumExt, Colonia, Codigo_Postal, Municipio, Estado, Pais);
