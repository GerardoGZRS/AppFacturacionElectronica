 ...
 * @author JAANP
 */
@WebServlet(name = "ServletActualizarEmpresa", urlPatterns = {"/ServletActualizarEmpresa"})
...
//favor de no remover el codigo.....
       ...
       if(!IdEmpresa.equalsIgnoreCase("")&&!Empresas.equalsIgnoreCase("")&&
         !Razon.equalsIgnoreCase("")&&!RFC.equalsIgnoreCase("")&&
           ...
           boolean sw = Empresa.modificar(beanEmpresa);
if(sw){ 
    out.println("<center>");
    out.println("<h2>Usted ha modificado el registro</h2>");
    out.println("<td><a href=\"administrador.html\">Regresar a la pagina principal</a></td>" ); 
    out.println("</center>");
         } else {
    out.println("<center>");
    out.println("<h2>No a podido modificar el registro</h2>");
    out.println("<td><a href=\"administrador.html\">Regresar a la pagina principal</a></td>" ); 
    out.println("</center>");
       }
    }
